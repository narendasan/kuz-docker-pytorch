...
RUN apt-get install -y --no-install-recommends build-essential python3.6 python3.6-dev python3-pip python3.6-venv python3-dev python3-setuptools python3-wheel
